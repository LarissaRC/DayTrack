...
eventos = [
    ("Passeio no parque", "Passeio no parque de tarde com os meus amigos :)", "2023-01-20 16:00:00.000", id2),
    ("Reunião da faculdade", "Reunião com os membros da minha equipe para dividir as tarefas", "2023-02-03 09:30:00.000", id2),
    ("Atividade de MPS", "Entregar o diagrama de arquitetura.", "2023-03-13 18:15:00.000", id1),
    ("Apresentação de Redes", "Apresentação sobre o protocolo TCP.", "2023-01-10 16:20:00.000", id1),
    ("Aniversário da mamãe", "Festa na casa da vovó, não esquecer o bolo!", "2023-02-04 20:00:00.000", id1)
]
